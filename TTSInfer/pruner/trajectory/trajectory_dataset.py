"""
Trajectory dataset utilities for pruner training and evaluation.
...
class TrajectoryDataset(Dataset):
    ...
    def _collate_frames(self, frame_batch: List[Dict]) -> Dict:
        ...
        batched_action = torch.stack(action_list, dim=0)
...
def create_trajectory_dataset(
    ...
    """Create a trajectory dataset from an episode directory."""
...
def create_trajectory_dataloaders(
    ...
    """Create train/validation trajectory datasets."""
    print("=" * 80)
